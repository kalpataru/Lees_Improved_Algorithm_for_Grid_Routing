...
class Grid extends Panel {
  ...
  public Grid(int w, int h, int d) {  //       constructor originally called by applet
    gridArray = new GridPoint[w][h][d];// instance of GridPoint class
    for (int i = 0; i < w; i++ )
      for (int j = 0; j < h; j++)
        for (int k = 0; k < d; k++)
...
//      System.out.println("GridPoint.dequeuePoint - " + gp);
  ...
  private static final int DELAY = 200; // 10ms = 0.1s
